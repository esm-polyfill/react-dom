 ...
 */
var k=react,l=reactDom;function m(a){var b=a,c=a;if(a.alternate)for(;b.return;)b=b.return;else {a=b;do b=a,0!==(b.flags&4098)&&(c=b.return),a=b.return;while(a)}return 3===b.tag?c:null}function n(a){if(m(a)!==a)throw Error("Unable to find node on an unmounted component.");}
...
var Simulate = reactDomTestUtils_production_min.Simulate=Z;var act = reactDomTestUtils_production_min.act=xa;var findAllInRenderedTree = reactDomTestUtils_production_min.findAllInRenderedTree=S;var findRenderedComponentWithType = reactDomTestUtils_production_min.findRenderedComponentWithType=function(a,b){O(a,"findRenderedComponentWithType");a=V(a,b);if(1!==a.length)throw Error("Did not find exactly one match (found: "+a.length+") for componentType:"+b);return a[0]};var findRenderedDOMComponentWithClass = reactDomTestUtils_production_min.findRenderedDOMComponentWithClass=function(a,b){O(a,"findRenderedDOMComponentWithClass");a=T(a,b);if(1!==a.length)throw Error("Did not find exactly one match (found: "+a.length+") for class:"+b);return a[0]};
var findRenderedDOMComponentWithTag = reactDomTestUtils_production_min.findRenderedDOMComponentWithTag=function(a,b){O(a,"findRenderedDOMComponentWithTag");a=U(a,b);if(1!==a.length)throw Error("Did not find exactly one match (found: "+a.length+") for tag:"+b);return a[0]};var isCompositeComponent = reactDomTestUtils_production_min.isCompositeComponent=Q;var isCompositeComponentWithType = reactDomTestUtils_production_min.isCompositeComponentWithType=R;var isDOMComponent = reactDomTestUtils_production_min.isDOMComponent=P;var isDOMComponentElement = reactDomTestUtils_production_min.isDOMComponentElement=function(a){return !!(a&&k.isValidElement(a)&&a.tagName)};var isElement = reactDomTestUtils_production_min.isElement=function(a){return k.isValidElement(a)};
var isElementOfType = reactDomTestUtils_production_min.isElementOfType=function(a,b){return k.isValidElement(a)&&a.type===b};var mockComponent = reactDomTestUtils_production_min.mockComponent=function(a,b){b=b||a.mockTagName||"div";a.prototype.render.mockImplementation(function(){return k.createElement(b,null,this.props.children)});return this};var nativeTouchData = reactDomTestUtils_production_min.nativeTouchData=function(a,b){return {touches:[{pageX:a,pageY:b}]}};var renderIntoDocument = reactDomTestUtils_production_min.renderIntoDocument=function(a){var b=document.createElement("div");return l.render(a,b)};var scryRenderedComponentsWithType = reactDomTestUtils_production_min.scryRenderedComponentsWithType=V;
var scryRenderedDOMComponentsWithClass = reactDomTestUtils_production_min.scryRenderedDOMComponentsWithClass=T;var scryRenderedDOMComponentsWithTag = reactDomTestUtils_production_min.scryRenderedDOMComponentsWithTag=U;var traverseTwoPhase = reactDomTestUtils_production_min.traverseTwoPhase=X;

export { Simulate, act, reactDomTestUtils_production_min as default, findAllInRenderedTree, findRenderedComponentWithType, findRenderedDOMComponentWithClass, findRenderedDOMComponentWithTag, isCompositeComponent, isCompositeComponentWithType, isDOMComponent, isDOMComponentElement, isElement, isElementOfType, mockComponent, nativeTouchData, renderIntoDocument, scryRenderedComponentsWithType, scryRenderedDOMComponentsWithClass, scryRenderedDOMComponentsWithTag, traverseTwoPhase };
