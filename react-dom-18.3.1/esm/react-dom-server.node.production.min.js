 ...
 */
var aa=util,ba=react,k=null,l=0,q=!0;
...
var renderToPipeableStream = reactDomServer_node_production_min.renderToPipeableStream=function(a,b){var c=od(a,b),d=!1;jd(c);return {pipe:function(a){if(d)throw Error("React currently only supports piping to one writable stream.");d=!0;kd(c,a);a.on("drain",md(a,c));a.on("error",nd(c,Error("The destination stream errored while writing data.")));a.on("close",nd(c,Error("The destination stream closed early.")));return a},abort:function(a){ld(c,a);}}};var version = reactDomServer_node_production_min.version="18.3.1";

export { reactDomServer_node_production_min as default, renderToPipeableStream, version };
